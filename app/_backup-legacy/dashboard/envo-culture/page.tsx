...
import { cultureImpacts } from "@/app/dashboard/_backup-removed-insights/components/dashboard-tab-data";
import ESGMetricsCard from "@/app/dashboard/_backup-removed-insights/components/esg-metrics-card";
import CultOrgHealthPulse from "@/app/dashboard/_backup-removed-insights/components/cult-org-health-pulse";
import CultEmotionalMap from "@/app/dashboard/_backup-removed-insights/components/cult-emotional-map";
import CultMotivationIndex from "@/app/dashboard/_backup-removed-insights/components/cult-motivation-index";
import CultEngagementOverview from "@/app/dashboard/_backup-removed-insights/components/cult-engagement-overview";
import CultSatisfactionDeepdive from "@/app/dashboard/_backup-removed-insights/components/cult-satisfaction-deepdive";
import CultLeadershipTrust from "@/app/dashboard/_backup-removed-insights/components/cult-leadership-trust";
import CultAlertsPatterns from "@/app/dashboard/_backup-removed-insights/components/cult-alerts-patterns";

export const metadata: Metadata = {
  title: "Workenvo | Legacy – Culture",
};
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
        ...
        <CapabilityIndexCard
          ...
          trendPositive
          href="/legacy/dashboard/envo-culture/score"
          ...
          bars={bars}
          metrics={[
            { label: "Belonging", value: "Strong", href: "/legacy/dashboard/envo-culture/pillar/belonging" },
            { label: "Psych. Safety", value: "Growing", href: "/legacy/dashboard/envo-culture/pillar/psychological-safety" },
            { label: "Recognition", value: "Steady", href: "/legacy/dashboard/envo-culture/pillar/recognition" },
            { label: "Feedback Culture", value: "Emerging", href: "/legacy/dashboard/envo-culture/pillar/feedback-culture" },
          ]}
        />
