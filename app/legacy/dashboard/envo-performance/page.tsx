...
import ActionImpactLog from "@/app/dashboard/_backup-removed-insights/components/action-impact-log";
import CapabilityIndexCard from "@/app/dashboard/_backup-removed-insights/components/capability-index-card";
import AIRecommendationsPanel from "@/app/dashboard/_backup-removed-insights/components/ai-recommendations-panel";
import BehaviouralSignalsCard from "@/app/dashboard/_backup-removed-insights/components/behavioural-signals-card";
import { performanceImpacts } from "@/app/dashboard/_backup-removed-insights/components/dashboard-tab-data";
import ESGMetricsCard from "@/app/dashboard/_backup-removed-insights/components/esg-metrics-card";
import PerfRatingDistribution from "@/app/dashboard/_backup-removed-insights/components/perf-rating-distribution";
import PerfGoalAchievement from "@/app/dashboard/_backup-removed-insights/components/perf-goal-achievement";
import PerfTrendsQuarterly from "@/app/dashboard/_backup-removed-insights/components/perf-trends-quarterly";
import PerfRecognitionActivity from "@/app/dashboard/_backup-removed-insights/components/perf-recognition-activity";
import PerfAppraisalTracker from "@/app/dashboard/_backup-removed-insights/components/perf-appraisal-tracker";
import PerfGoalTracking from "@/app/dashboard/_backup-removed-insights/components/perf-goal-tracking";
import PerfRewardLeaderboard from "@/app/dashboard/_backup-removed-insights/components/perf-reward-leaderboard";

export const metadata: Metadata = {
  title: "Workenvo | Legacy – Performance",
};
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
        ...
        <CapabilityIndexCard
          ...
          trendPositive={false}
          href="/legacy/dashboard/envo-performance/score"
          ...
          bars={bars}
          metrics={[
            { label: "Goal Completion", value: "82%", href: "/legacy/dashboard/envo-performance/pillar/goal-completion" },
            { label: "Output Quality", value: "High", href: "/legacy/dashboard/envo-performance/pillar/output-quality" },
            { label: "Responsiveness", value: "Stable", href: "/legacy/dashboard/envo-performance/pillar/responsiveness" },
            { label: "Growth Velocity", value: "Accelerating", href: "/legacy/dashboard/envo-performance/pillar/growth-velocity" },
          ]}
        />
